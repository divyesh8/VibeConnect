            ...
            <GlassCard className="overflow-hidden rounded-[32px] p-5 sm:p-7">
              <div className="relative overflow-hidden rounded-[25px] border border-white/[0.08] bg-black/20 p-6 sm:p-8">
                ...
                <div className="relative flex flex-col items-center gap-5 text-center sm:flex-row sm:text-left">
                  ...
                  <div className="flex-1"><div className="flex flex-wrap items-center justify-center gap-2 sm:justify-start"><h2 className="font-display text-2xl font-bold tracking-[-.04em]">{profile.username}</h2><span className="rounded-full border border-[#78f7df]/15 bg-[#78f7df]/[0.07] px-2.5 py-1 text-[9px] font-black uppercase tracking-wider text-[#8cf7e2]">active</span></div><p className="mt-2 text-xs capitalize text-white/35">{profile.gender.replaceAll("_", " ")} · video calls</p></div>
                </div>
              </div>
