-- Keep recent partners behind fresh candidates instead of excluding them.
-- This lets a real two-person queue reconnect during testing or in a small
-- deployment while still preferring someone the requester has not just met.
