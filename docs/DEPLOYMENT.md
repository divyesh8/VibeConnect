...
1. Create a Supabase project and run `supabase/schema.sql` in the SQL editor. For an existing database, apply `supabase/migrations/002_real_human_only_matching.sql` and then `supabase/migrations/003_webrtc_room_hardening.sql`.
